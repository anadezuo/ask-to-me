...
export function Room() {
  ...
  async function handleSendQuestions(event: FormEvent) {
    ...
    if (!user) {
      throw new Error("You must be logged in."); //TODO: toast
    }
    ...
    setNewQuestion(""); //para apagar o texto digitado
  }
  ...
  //TODO: para exclusao de pergunta, pode ser usado o modal
            ...
            */
            ...
            isHighlighted={quest.isHighlighted}>
              ...
              >
                ...
                {/* com o SVG aqui no fonte, eh possível trocar a cor do mesmo*/}
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
